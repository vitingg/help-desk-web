    ...
    <div>
      ...
      <div className="flex flex-col md:flex-row gap-6 pt-6 justify-center">
        ...
        <div className="border border-gray-500 p-4 rounded-lg max-w-md">
          ...
          <div>
            <p className="text-gray-300 text-2xs font-bold pt-5 pb-2">MANHÃ</p>
          ...
          <div>
            <p className="text-gray-300 text-2xs font-bold pt-5 pb-2">TARDE</p>
            <div className="flex font-bold gap-2 text-sm">
          ...
          <div>
            <p className="text-gray-300 text-2xs font-bold pt-5 pb-2">NOITE</p>
            <div className="flex font-bold gap-2 text-sm">
